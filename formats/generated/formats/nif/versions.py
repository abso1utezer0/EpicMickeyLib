...
def is_v20_2_4_7(context):
	if context.version == 335676694:
		return True


def set_v20_2_4_7(context):
	context.version = 335676694
...
def set_game(context, game):
	...
	if game in {games.FREEDOM_FORCE_VS_THE_3_RD_REICH, games.AXIS_AND_ALLIES, games.SID_MEIER_S_PIRATES, games.EMPIRE_EARTH_II, games.KOHAN_2}:
		return set_v10_1_0_0(context)
	if game in {games.RED_OCEAN, games.PRO_CYCLING_MANAGER, games.WILDLIFE_PARK_2, games.PRISON_TYCOON}:
	...
	if game in {games.EMPIRE_EARTH_III, games.FFT_ONLINE}:
	...
	if game in {games.AURA_KINGDOM, games.FANTASY_FRONTIER}:
		return set_v20_3_1_2(context)
	if game in {games.MICRO_VOLTS, games.RAGNAROK_ONLINE_2, games.IRIS_ONLINE}:
	...
	if game in {games.DARK_AGE_OF_CAMELOT, games.EMPIRE_EARTH_II, games.CIVILIZATION_IV}:
		return set_v4_2_2_0(context)
	if game in {games.OBLIVION, games.CIVILIZATION_IV}:
		return set_v10_0_1_0(context)
	if game in {games.OBLIVION}:
		return set_v10_0_1_2(context)
	if game in {games.NEO_STEAM, games.CIVILIZATION_IV, games.THE_GUILD_2, games.DARK_AGE_OF_CAMELOT, games.WILDLIFE_PARK_2}:
		return set_v10_1_0_0(context)
	if game in {games.OBLIVION}:
	...
	if game in {games.FLORENSIA, games.RAGNAROK_ONLINE_2, games.IRIS_ONLINE}:
		return set_v20_0_0_4(context)
	if game in {games.OBLIVION}:
		return set_v20_0_0_4__10(context)
	if game in {games.OBLIVION, games.FALLOUT_3}:
		return set_v20_0_0_4__11(context)
	if game in {games.WIZARD_101, games.EMPIRE_EARTH_III, games.ATLANTICA_ONLINE, games.IRIS_ONLINE}:
		return set_v20_2_0_7(context)
	if game in {games.FALLOUT_NV, games.FALLOUT_3}:
	...
	if game in {games.WIZARD_101, games.ATLANTICA_ONLINE, games.IRIS_ONLINE}:
		return set_v20_2_0_8(context)
	...
	if game in {games.LAZESKA, games.DIVINITY_2_0_X_10000, games.RAGNAROK_ONLINE_2, games.WARHAMMER, games.HOWLING_SWORD, games.DIGIMON_MASTERS_ONLINE}:
		return set_v20_3_0_9(context)
	if game in {games.AURA_KINGDOM, games.FANTASY_FRONTIER}:
		return set_v20_3_1_1(context)
	if game in {games.MICRO_VOLTS, games.KRAZY_RAIN}:
		return set_v20_5_0_0(context)
	if game in {games.WIZARD_101, games.KRAZY_RAIN, games.ARCHLORD_2, games.ATLANTICA_ONLINE}:
		return set_v20_6_0_0(context)
	...
	if game in {games.ROCKSMITH, games.ROCKSMITH_2014}:
...
v20_2_4_7 = NifVersion(id='V20_2_4_7', num=(335676423,), primary_games=[games.Q_Q_SPEED], all_games=[games.Q_Q_SPEED])
v20_2_4_7 = NifVersion(id='V20_2_4_7', num=(335676694,), primary_games=[], all_games=[games.Q_Q_SPEED])
